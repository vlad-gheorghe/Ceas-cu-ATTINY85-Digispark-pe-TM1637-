...
#include "TM1637.h" 
#include <DHT.h> 
#define DHTPIN PB3    // what pin we're connected the DHT output
...
#define DIO PB4
#define brightness 7 
//pb0 sda ds3231/ds1307
//pb2 scl ds3231/ds1307
 int h;  //REGLAJ ORA pentru 4,5V reglaj minute pentru 3V
// int m;  //REGLAJ MINUTE
...
void clk(){
 ...
 if(ClockPoint)tm1637.point(POINT_ON);
   ...
   h = analogRead(0);   // REGLAJ ORA  // REGLAJ ORA
 // m = analogRead(PA1);   //REGLAJ MINUTE
